...
class JourneyIcalConverterTest {
    private static Journey exampleJourney() {
        ...
        var l1 = new Journey.Leg.Transport(s1, d.atTime(16, 13), s2, d.atTime(16, 19), List.of(), Vehicle.METRO, "m1",
                "Renens VD, gare");

        var l2 = new Journey.Leg.Foot(s2, d.atTime(16, 19), s3, d.atTime(16, 22));

        var l3 = new Journey.Leg.Transport(s3, d.atTime(16, 26), s4, d.atTime(16, 33), List.of(), Vehicle.TRAIN, "R4",
                "Bex");

        var l4 = new Journey.Leg.Foot(s4, d.atTime(16, 33), s5, d.atTime(16, 38));

        var l5 = new Journey.Leg.Transport(s5, d.atTime(16, 40), s6, d.atTime(17, 13), List.of(), Vehicle.TRAIN, "IR15",
                "Luzern");
    ...
    void journeyIcalConverterToIcalendarWorks() {
        ...
        for (var line : unfoldedActual.split("\r\n")) {
            ...
            case "DESCRIPTION" -> {
                assertEquals("16h13 Ecublens VD, EPFL → Renens VD, gare (arr. 16h19)\\n" + "trajet à pied (3 min)\\n"
