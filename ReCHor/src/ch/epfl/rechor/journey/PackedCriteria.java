...
public abstract class PackedCriteria {
     ...
     * @throws IllegalArgumentException if arrival time is invalid or change is not in 7 bits
     */
     ...
     * @return checks if the first packaged criteria domainates or is equal to the second
     * @throws IllegalArgumentException if one of the criteria has a start time and the other doesn't
     */
